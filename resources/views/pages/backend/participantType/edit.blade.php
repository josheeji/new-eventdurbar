                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="file" name="url" class="form-control" id="url" placeholder="Upload Certificate url"
                            value="{{ old('url') ?? $participantType->url}}">
                    </div>
                    @error('url')
                        <span class='text-danger'>{{ $message }}</span>
                    @enderror
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="template_height" class="form-control" id="template_height"
                            placeholder="Template Height" value="{{ old('template_height') ?? $participantType->template_height }}">
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="template_width" class="form-control" id="template_width"
                            placeholder="Template Width" value="{{ old('template_width')  ?? $participantType->template_width}}">
                    </div>
